...
square[0] = new Square("GO", "ПОЛУЧИТЕ $200 ПРИ ПРОХОДЕ ЧЕРЕЗ ЭТУ КЛЕТКУ.", "#FFFFFF");
...
square[4] = new Square("City Tax", "Заплатите $200", "#FFFFFF");
...
square[7] = new Square("Chance", "СЛЕДУЙТЕ ИНСТРУКЦИЯМ НА ВЕРХНЕЙ КАРТОЧКЕ", "#FFFFFF");
