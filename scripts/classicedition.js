...
square[8] = new Square("Мармонтова улица", "$100", "#87CEEB", 100, 4, 6, 30, 90, 270, 400, 550);
...
square[13] = new Square("Штатский проспект", "$140", "#FF0080", 140, 5, 10, 50, 150, 450, 625, 750);
